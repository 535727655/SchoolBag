...
<script src="/schoolBag/js/jquery-3.0.0.js"></script>
<title>任务详情</title>
</head>
	<style>
		body{
		...
		<div id="head">
			...
			<div class="context">
				<div class="context-1">
						...
						<c:forEach var ="s" items="${requestScope.bl}" varStatus="i">
       					...
       					<div class="context-1-2">
       						...
       						<div class="context-1-2-2">
       							...
       							<div class="context-1-2-2-1">
       								...
       								<p ><span class="p2"><b><a id="st" href="InTaskRec?TaskId2=${s.taskId}">立即领取</a></b></span></p>
       							</div>                      
       						</div>
       					</div>
       				
       				<c:if test="${s.taskUserid==sessionScope.user.userId&&i.index==0 }">
       					<script>
       						$(function(){
