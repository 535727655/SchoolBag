				...
				if(data==0){
					...
					$.each(eval(data),function(i,v){
						$("#youbian-1").append(
								...
								+'		<div class="wenzi1"><b><a href="/schoolBag/TaskId2?taskId='+v.taskId+'" style="text-decoration:none;font-size:20px">'+v.taskTitle+'</a></b></div>'
								...
								+'		<div class="duan4">价格：<b style="color:red;font-size:20px">'+v.taskMoney+'</b style="color:red">元</div>'
								+'		<div class="duan5"><a href="/schoolBag/TaskId2?taskId='+v.taskId+'"style="text-decoration:none">立即查看</a></div>'
								+'</div>'
								+'	</div>'
						);
					})
